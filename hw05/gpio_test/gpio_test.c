...
static unsigned int LEDarr[3] = {gpioLED, gpioLED1, gpioLED2};
static unsigned int BUTTarr[3] = {gpioButton, gpioButton1, gpioButton2};
static unsigned int *IRQarr[3] = {&irqNumber,&irqNumber1 , &irqNumber2};
int i;
